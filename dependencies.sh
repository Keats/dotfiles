...
# Misc
sudo pacman -S arandskype unclutter flashplugin dunst scrot feh evince conky redshift firefox dmenu xf86-input-synaptics numix-themes lxappearance
...
# Sound
sudo pacman -S pulseaudio pulseaudio-alsa lib32-libpulse lib32-alsa-plugins pavucontrol
